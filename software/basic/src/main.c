...
#define IO_INIT()         (uart_begin(115200))
#define PUTCHAR(x)        (uart_printchar(*x))
#define GETCHAR(x)        { while (!uart_checkrxbuffer()); *x = uart_readchar(); }
#define IO_CHECK(x)       (*x = uart_checkrxbuffer())
